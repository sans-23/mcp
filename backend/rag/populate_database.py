...
# --- Switched to a free, local model to avoid API key issues ---

# Model choice: sentence-transformers/all-MiniLM-L6-v2 is a small,
# fast, and high-performing model for RAG running locally.
